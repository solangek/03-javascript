const person = {
  ...
  age: 29,
  greet() {
    // here no need to write greet : function() { ... }  since JS is smart enough to understand that this is a function
...
const printName = ({ name }) => {
  // the parameter is an object with a property name - we deconstruct the object with {}
  console.log(name);
};
